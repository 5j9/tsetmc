...
def test_get_page_info_no_free_float():
    ...
    assert d == {
        ...
        , 'related_companies': [
            ...
            [44818950263583523, 'دی', 'بانک دی'],
            [28320293733348826, 'وبصادر', 'بانک صادرات ایران'],
            [63917421733088077, 'وتجارت', 'بانک تجارت'],
            [33293588228706998, 'وپارس', 'بانک\u200cپارسیان\u200c'],
            [47302318535715632, 'ونوین', 'بانک\u200cاقتصادنوین\u200c'],
            [9536587154100457, 'وپاسار', 'بانک  پاسارگاد'],
            [41379697187196382, 'وشهر', 'بانک شهر'],
            [22087269603540841, 'وپست', 'پست بانک ایران'],
            [45050389997905274, 'وسینا', 'بانک سینا'],
            [7920014658832193, 'وگردش', 'بانک گردشگری'],
            [38179358042686391, 'سامان', 'بانک سامان'],
            [24644999329120295, 'وملل', 'اعتباری ملل'],
            [47996917271187218, 'وکار', 'بانک\u200c کارآفرین\u200c'],
            [23175320865252772, 'وسالت', 'بانک قرض الحسنه رسالت'],
            [46830341954511303, 'وآیند', 'بانک  آینده'],
            [49776615757150035, 'وانصار', 'بانک انصار'],
            [47333458678352378, 'وخاور', 'بانک خاورمیانه'],
            [20626178773287666, 'وآیند', 'بانک آینده'],
            [43913530989262989, 'سمایه', 'بانک سرمایه'],
            [19954896371640204, 'وزمین', 'بانک ایران زمین'],
            [7881099657101647, 'حکمت', 'بانک حکمت  ایرانیان'],
            [49396161442874149, 'وقوام', 'بانک قوامین'],
            [7769065543658313, 'توسعه', 'اعتباری توسعه'],
            [41036181221659834, 'وکوثر', 'شرکت اعتباری  کوثر مرکزی'],
            [71665987033532474, 'ومهر', 'بانک مهر اقتصاد'],
            [20236748310756911, 'ورفاه', 'بانک رفاه کارگران'],
            [57424362806755583, 'ونور', 'اعتباری نور'],
            [70841787274602388, 'وثامن', 'شرکت اعتباری ثامن'],
            [34186024944625724, 'حذف -آرین', 'بانک الکترونیکی آرین']],
    }
...
def test_get_page_info_no_eps():
    ...
    assert d == {
        ...
        , 'year_min': 12376.0
        , 'related_companies': [
            [60523145697836739, 'بورس', 'بورس اوراق بهادار تهران'],
            [18599703143458101, 'امید', 'تامین سرمایه امید'],
            [58873907630765023, 'امین', 'تامین سرمایه امین'],
            [58741071099161284, 'فرابورس', 'فرابورس ایران'],
            [44549439964296944, 'کالا', 'بورس کالای ایران'],
            [49641108336531623, 'انرژی3', 'سایراشخاص بورس انرژی'],
            [25357135030606405, 'تنوین', 'تامین سرمایه نوین'],
            [59142194115401696, 'لوتوس', 'تامین سرمایه لوتوس پارسیان'],
            [11129387075131725, 'تملت', 'تامین سرمایه بانک ملت'],
            [42256988946157416, 'تماوند', 'تامین سرمایه دماوند'],
            [61725225143026283, 'انرژی1', 'نهادهای مالی بورس انرژی'],
            [49869693814643443, 'اکالا', 'کارگزاران بورس کالای ایران'],
            [37366608481858080, 'کبورس', 'کارگزاران بورس اوراق بهادار'],
            [16330743198286823, 'انرژی2', 'فعالان بورس انرژی'],
            [67612261115225625, 'تکالا', 'تولیدکنندگان بورس کالای ایران'],
            [60095061789823130, 'نبورس', 'نهادهای مالی بورس اوراق بهادار'],
            [10919655792568926, 'نکالا', 'نهادهای مالی بورس کالای ایران'],
            [63531021766590755, 'سپرده', 'سپرده گذاری مرکزی و تسویه وجوه'],
            [68215656200943332, 'تامین سپهر', 'تامین سرمایه سپهر'],
            [50374488794681480, 'تماوند', 'تامین سرمایه دماوند-پذیره'],
            [68980134713666314, 'سپرده گذاری', 'سپرده گذاری مرکزی اوراق بهادار'],
            [63679592178109910, 'تمدن', 'تامین سرمایه تمدن']],
    }
...
def test_get_page_info_no_sector_pe():
    ...
    assert d == {
        ...
        ,  'related_companies': [
            ...
            [44891482026867833, 'خساپا', 'سایپا'],
            [48990026850202503, 'خگستر', 'گسترش\u200cسرمایه\u200cگذاری\u200cایران\u200cخودرو'],
            [42354736493447489, 'خپارس', 'پارس\u200c خودرو'],
            [7483280423474368, 'خاهن', 'آهنگری\u200c تراکتورسازی\u200c ایران\u200c'],
            [50185721305191887, 'ختور', 'رادیاتور ایران\u200c'],
            [26824673819862694, 'خبهمن', 'گروه\u200cبهمن\u200c'],
            [39436183727126211, 'خمحرکه', 'نیرو محرکه\u200c'],
            [70289374539527245, 'ختوقا', 'قطعات\u200c اتومبیل\u200c ایران\u200c'],
            [45895339414786358, 'خرینگ', 'رینگ\u200cسازی\u200cمشهد'],
            [32821908911812078, 'خزر', 'فنرسازی\u200cزر'],
            [2589887561569709, 'خزامیا', 'زامیاد'],
            [7385624172574740, 'ورنا', 'سرمایه\u200cگذاری\u200c رنا(هلدینگ\u200c'],
            [42075223783409640, 'خاذین', 'سایپاآذین\u200c'],
            [12752224677923341, 'خریخت', 'صنایع\u200cریخته\u200cگری\u200cایران\u200c'],
            [17330546482145553, 'خمهر', 'مهرکام\u200cپارس\u200c'],
            [59217041815333317, 'خکار', 'ایرکا پارت صنعت'],
            [63915926161403347, 'خشرق', 'الکتریک\u200c خودرو شرق\u200c'],
            [16315910303613772, 'خاور', 'ایران خودرو دیزل'],
            [22903901709044823, 'ختراک', 'ریخته\u200cگری\u200c تراکتورسازی\u200c ایران\u200c'],
            [33783140337377394, 'خچرخش', 'چرخشگر'],
            [31879190587976736, 'خوساز', 'محورسازان\u200cایران\u200cخودرو'],
            [19257295292088310, 'خکمک', 'کمک\u200cفنرایندامین\u200c'],
            [38084304113529336, 'خدیزل', 'بهمن  دیزل'],
            [17834623106317041, 'خنصیر', 'مهندسی\u200cنصیرماشین\u200c'],
            [66127247173352975, 'تشتاد', 'صنایع تولیدی اشتاد ایران\u200c'],
            [57273529732791251, 'خموتور', 'موتورسازان\u200cتراکتورسازی\u200cایران\u200c'],
            [14957056743925737, 'خلنت', 'لنت\u200c ترمزایران\u200c'],
            [4758266259250794, 'خپویش', 'سازه\u200c پویش\u200c'],
            [28033133021443774, 'خفنر', 'فنرسازی\u200cخاور'],
            [7457232989848872, 'خمحور', 'تولیدمحورخودرو'],
            [29527985620948695, 'خکرمان', 'گروه اقتصادی کرمان خودرو'],
            [50117925085549635, 'خلیبل', 'مالیبل سایپا'],
            [64842837716888827, 'خکاوه', 'سایپا دیزل'],
            [6433335428452486, 'خعمرا', 'توسعه و عمران شهرستان نائین'],
            [58180284328186631, 'خفناور', 'مهندسی صنعتی روان فن آور'],
            [70427037538843530, 'صایپا203', 'صکوک مرابحه سایپا203-3ماهه 16%'],
            [52365266148848270, 'صخود412', 'ص مرابحه خودرو412- 3ماهه 18%'],
            [28025154952452710, 'صخود0004', 'صکوک رهنی خودرو0004- 3ماهه 16%'],
            [48102697378515196, 'صایپا412', 'صکوک مرابحه سایپا412-3ماهه 16%'],
            [57082592909752827, 'صایپا012', 'صکوک مرابحه سایپا012-3ماهه 16%'],
            [2849875720026255, 'صایپا112', 'صکوک مرابحه سایپا112-3ماهه 16%'],
            [55511667328361694, 'صخود1404', 'صکوک رهنی خودرو1404- 3ماهه 16%'],
            [68846812677163892, 'صخود0012', 'ص مرابحه خودرو0012- 3ماهه 18%'],
            [65647223172013387, 'صایپا143', 'صکوک اجاره سایپا143-3ماهه18%'],
            [36385738315834272, 'صایپا403', 'صکوک اجاره سایپا403-3ماهه18%'],
            [48762046694019828, 'صخود1412', 'ص مرابحه خودرو1412- 3ماهه 18%'],
            [18275313863657221, 'صایپا104', 'صکوک اجاره سایپا - 3ماهه18%'],
            [22645269567765904, 'خیمن', 'ایمن خودرو شرق'],
            [52888670015136433, 'کرمان خودرو', 'گروه اقتصادی کرمان خودرو-پذیره'],
            [28679034713062084, 'ایران دوچرخ', 'ایران دوچرخ'],
            [45446499784751546, 'ریخته گری تبریز', 'ریخته گری ماشین سازی تبریز'],
            [58208801871943418, 'خاذر', 'تولیدی آذر باتری ارومیه']],
    }
